...
sn1.onclick = function(){
	...
	if(ge==1){
		si1=0;
		this.style.border="0px solid gold";
	}
}
...
sr1.onclick = function(){
	if(mem==0){
		mem=1
		sr1.style.border="3px solid gold";
	}else
	if(mem==1){
		mem=0
		sr1.style.border="0px solid gold";
		console.log("sfasdf")
	}
	console.log(mem)
}
...
RU.onclick = function(){
	in1.innerHTML='<h1>MyStory - это международная соц.сеть, помогающая начинающим и опытным писателям-пенсионерам, которые хотят раскрыть свой потенциал или столкнулись с сложностями издательства</h1>';
	in2.innerHTML='<h1>Опубликуйте свою литературную работу и начните зарабатывать уже сегодня, а также получайте комментарии и лайки</h1';
	in3.innerHTML='<h1>Дополнительно вы можете оформить премиум-подписку в которую входит ряд преимуществ: услуги худ.редактора, продвижение поста, неогр. кол-во публикаций на разных языках</h1>';
	right1.innerHTML='<font color="gold"><h1><p align = "center">Добавить работу</p></h1></font>';
	left1.innerHTML='<font color="gold"><h1><p align = "center">Читать</p></h1></font>';
	up_panel.innerHTML='<font color="gold"><h1>Комментарии</h1></font>';
	back1.innerHTML='<font color="gold"><h1>Назад</h1></font>';
	buy1.innerHTML='<font color="gold"><p align="center"><h1>Купить</h1></p></font>';
	sha1.innerHTML='<h1>Жанр:</h1>';
	sha2.innerHTML='<h1>Текст:</h1>';
	sr1.innerHTML='<font color="gold"><h1>Мемуар</h1></font>';
	sr2.innerHTML='<font color="gold"><h1>Стих</h1></font>';
	sr3.innerHTML='<font color="gold"><h1>Детектив</h1></font>';
	sr4.innerHTML='<font color="gold"><h1>Сказка</h1></font>';
	sr5.innerHTML='<font color="gold"><h1>Роман</h1></font>';
	sn1.innerHTML='<font color="gold"><h1>Жирный</h1></font>';
	sn2.innerHTML='<font color="gold"><i>Курсив</i></font>';
	sn3.innerHTML='<font color="gold"><u>Подчёркнутый</u></font>';
	sn4.innerHTML='<font color="gold"><s>Зачёркнутый</s></font>';
	back2.innerHTML='<font color="gold"><h1>Назад</h1></font>';
	accept1.innerHTML='<font color="gold"><h1>Опубликовать</h1></font>';
...
EN.onclick = function(){
	in1.innerHTML='<h1>MyStory is an international social network that helps novice and experienced retired writers who want to reach their potential or face the difficulties of publishing</h1>';
	in2.innerHTML='<h1>Publish your literary work and start earning today, as well as get comments and likes</h1>';
	in3.innerHTML='<h1>Additionally, you can sign up for a premium subscription that includes a number of advantages: editor services, post promotion, profile customization, text customization, unlimited number of publications in different languages</h1>';
	right1.innerHTML='<font color="gold"><h1><p align = "center">Add work</p></h1></font>';
	left1.innerHTML='<font color="gold"><h1><p align = "center">To read</p></h1></font>';
	up_panel.innerHTML='<font color="gold"><h1>Comments</h1></font>';
	back1.innerHTML='<font color="gold"><h1>Back</h1></font>';
	buy1.innerHTML='<p align="center"><h1>Buy</h1></p>';
	sha1.innerHTML='<h1>Genre:</h1>';
	sha2.innerHTML='<h1>Text:</h1>';
	sr1.innerHTML='<font color="gold"><h1>Memoir</h1>';
	sr2.innerHTML='<font color="gold"><h1>Verse</h1>';
	sr3.innerHTML='<font color="gold"><h1>Detective</h1>';
	sr4.innerHTML='<font color="gold"><h1>Story</h1>';
	sr5.innerHTML='<font color="gold"><h1>Novel</h1>';
	sn1.innerHTML='<font color="gold"><h1>Fatty</h1>';
	sn2.innerHTML='<font color="gold"><i>Italics</i>';
	sn3.innerHTML='<font color="gold"><u>Underlined</u>';
	sn4.innerHTML='<font color="gold"><s>Strikethrough</s>';
	back2.innerHTML='<font color="gold"><h1>Back</h1></font>';
	accept1.innerHTML='<font color="gold"><h1>Publish</h1></font>';
...
fEN.onclick = function(){
	...
	in2.innerHTML='<h1>Publish your literary work and start earning today, as well as get comments and likes</h1>';
	in3.innerHTML='<h1>Additionally, you can sign up for a premium subscription that includes a number of advantages: editor services, post promotion, profile customization, text customization, unlimited number of publications in different languages</h1>';
	right1.innerHTML='<font color="gold"><h1><p align = "center">Add work</p></h1>';
	left1.innerHTML='<font color="gold"><h1><p align = "center">To read</p></h1>';
	up_panel.innerHTML='<font color="gold"><h1>Comments</h1></font>';
	back1.innerHTML='<font color="gold"><h1>Back</h1></font>';
	buy1.innerHTML='<p align="center"><h1>Buy</h1></p>';
	sha1.innerHTML='<h1>Genre:</h1>';
	...
	sn3.innerHTML='<font color="gold"><u>Underlined</u>';
	sn4.innerHTML='<font color="gold"><s>Strikethrough</s>';
	back2.innerHTML='<font color="gold"><h1>Back</h1>';
	accept1.innerHTML='<font color="gold"><h1>Publish</h1>';
	sev.innerHTML='<pre><h1> Lang</h1></pre>';
	log2.innerHTML='<h1>ENTRANCE</h1>';
	log3.innerHTML='<h2>LOGIN</h2>';
	log5.innerHTML='<h2>PASSWORD</h2>';
